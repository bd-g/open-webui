...
app.state.config.AUDIO_STT_DEEPGRAM_API_BASE_URL = AUDIO_STT_DEEPGRAM_API_BASE_URL
app.state.config.AUDIO_STT_DEEPGRAM_API_KEY = AUDIO_STT_DEEPGRAM_API_KEY
app.state.config.AUDIO_TTS_DEEPGRAM_API_BASE_URL = AUDIO_TTS_DEEPGRAM_API_BASE_URL
app.state.config.AUDIO_TTS_DEEPGRAM_API_KEY = AUDIO_TTS_DEEPGRAM_API_KEY
